...
cp ./bin/release/net5.0/win-x64/publish/*.json ../package/win-x64-no-self-contained
dotnet publish -c release -r linux-x64 --no-self-contained
cp ./bin/release/net5.0/linux-x64/publish/*.json ../package/linux-x64-no-self-contained
